...
public String formatTelefono(String telefono) {
    ...
    if (digits.length() != 10) return telefono; // fallback
...
private void drawRoundedRect(PDPageContentStream content, float x, float y, float width, float height, float r) throws IOException {
...
public File generateReciboPDFxyz9(AlumnoAsistenciaDTO dto) throws IOException {
    ...
    // Position: center horizontally, vertically in the space between title and folio
